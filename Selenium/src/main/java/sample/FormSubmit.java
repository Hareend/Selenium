...
public class FormSubmit {
	...
	public static void main(String[] args)  {
		...
		//String actual_Text = "You must agree before submitting";
		//String expected_Text = "You must agree before submitting";
		WebDriver driver;
		...
		if(actual_text.equals("You must agree before submitting."))
		{
